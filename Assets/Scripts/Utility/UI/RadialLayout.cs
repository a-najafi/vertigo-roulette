...
{
    /// <summary>
    /// Arranges RectTransform children in a circle, auto-scaling and supporting aspect-ratio-aware layouts.
    /// </summary>
    [ExecuteAlways]
    public class RadialLayout : MonoBehaviour
    {
        ...
        /// <summary>
        /// Number of slots (children) to position in the radial layout.
        /// </summary>
        public int slotCount = 8;

        /// <summary>
        /// The percentage of the minimum dimension to use as the circle's radius.
        /// </summary>
        ...
        /// <summary>
        /// Populates the _children list with all RectTransform children.
        /// </summary>
        ...
        /// <summary>
        /// Calculates the usable visible area for layout, considering the aspect ratio of an Image component if present.
        /// </summary>
        ...
        /// <summary>
        /// Arranges child RectTransforms evenly around a circle, accounting for scaling and aspect ratio.
        /// </summary>

...
using UnityEngine;
    ...
    /// <summary>
    /// Custom property drawer for StateConfigurationBase.
    /// Provides UI for selecting the state GameObject and managing its transitions.
    /// </summary>
    ...
    public class StateConfigurationDrawer : PropertyDrawer
    {
        ...
        /// <summary>
        /// Cached types for possible transition classes.
        /// </summary>
        private static List<Type> _transitionTypes;

        /// <summary>
        /// Names for display in the add transition menu.
        /// </summary>
        ...
        /// <summary>
        /// Ensures the transition types and names are cached for menu use.
        /// </summary>
        ...
        /// <summary>
        /// Draws the custom property inspector for StateConfigurationBase.
        /// </summary>
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            // Draw the state GameObject field
            ...
            // Draw each transition in a boxed section
            ...
            // Draw the "+ Add Transition" button
        ...
        /// <summary>
        /// Calculates the required height for the custom inspector.
        /// </summary>
